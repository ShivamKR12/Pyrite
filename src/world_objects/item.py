...
from settings import (
    GRAVITY, ITEM_PICKUP_DELAY, ITEM_PICKUP_RADIUS, ITEM_SCALE, 
    ITEM_SPAWN_VELOCITY_MULTIPLIER, ITEM_ENTITY_CAP, ITEM_RENDER_DISTANCE_SQUARED, 
    STICK, WOODEN_PICKAXE, get_path
)
...
class Item:
    ...
    def __init__(self, app: Any, position: Any, voxel_id: int) -> None:
        ...
        self.velocity: Any = glm.vec3((random.random() - 0.5) * ITEM_SPAWN_VELOCITY_MULTIPLIER, 0.005, (random.random() - 0.5) * ITEM_SPAWN_VELOCITY_MULTIPLIER)
