...
SPAWN_SEARCH_RADIUS: int = 500000
...
# Items start after block IDs
STICK = 50
WOODEN_PICKAXE = 51

NON_PLACEABLE: Set[int] = {STICK, WOODEN_PICKAXE, BEDROCK}

# Texture Array Mapping (Global UID -> Row in tex_array_2.png)
TEXTURE_MAP: Dict[int, int] = {
    GRASS: 1, DIRT: 2, SAND: 3, GRAVEL: 4, STONE: 5, COBBLESTONE: 6, BEDROCK: 7,
    SANDSTONE: 8, RED_SAND: 9, RED_SANDSTONE: 10, CLAY: 11, OAK_LOG: 12,
    OAK_PLANKS: 13, SPRUCE_LOG: 14, SPRUCE_PLANKS: 15, BIRCH_LOG: 16,
    BIRCH_PLANKS: 17, JUNGLE_LOG: 18, JUNGLE_PLANKS: 19, ACACIA_LOG: 20,
    ACACIA_PLANKS: 21, DARK_OAK_LOG: 22, DARK_OAK_PLANKS: 23, OAK_LEAVES: 24,
    CACTUS: 25, ICE: 26, SNOW: 27, GLASS: 28, COAL_ORE: 29, IRON_ORE: 30,
    GOLD_ORE: 31, LAPIS_ORE: 32, DIAMOND_ORE: 33, EMERALD_ORE: 34,
    REDSTONE_ORE: 35,
    # These don't have textures in the main atlas but need to be in the map
    WATER: 99, GLOWSTONE: 98, STONE_BRICKS: 97
}
...
BLOCK_HARDNESS: Dict[int, int] = {
    GRASS: 450, DIRT: 400, SAND: 300, GRAVEL: 400,
    STONE: 1500, COBBLESTONE: 1500, BEDROCK: -1,  # Unbreakable
    SANDSTONE: 1200, RED_SAND: 300, RED_SANDSTONE: 1200, CLAY: 450,
    OAK_LOG: 1000, OAK_PLANKS: 800,
    SPRUCE_LOG: 1000, SPRUCE_PLANKS: 800,
    BIRCH_LOG: 1000, BIRCH_PLANKS: 800,
    JUNGLE_LOG: 1000, JUNGLE_PLANKS: 800,
    ACACIA_LOG: 1000, ACACIA_PLANKS: 800,
    DARK_OAK_LOG: 1000, DARK_OAK_PLANKS: 800,
    OAK_LEAVES: 150,
    CACTUS: 150, ICE: 250, SNOW: 200, GLASS: 100,
    COAL_ORE: 2000, IRON_ORE: 2500, GOLD_ORE: 2500,
    LAPIS_ORE: 2200, DIAMOND_ORE: 3000, EMERALD_ORE: 3000,
    REDSTONE_ORE: 2200,
    WATER: 0, GLOWSTONE: 100, STONE_BRICKS: 1500
}
